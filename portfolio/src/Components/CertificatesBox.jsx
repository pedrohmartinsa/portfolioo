                    ...
                    <div className="flex justify-center flex-wrap gap-9 max-w-6xl mx-auto">
                        {
                            ...
                            .map((detalhes) => (
                                <Link to= {`/certificates/${detalhes.id}/${detalhes.titulo}/${detalhes.tempo}/${detalhes.conteudo}/${detalhes.foto}`}
                                    className="group transform transition-transform hover:scale-125 mr-2 p-2 w-60 justify-center items-center hover:bg-primary hover:text-secondary duration-300 border-primary border-2 gap-4 rounded-md">
                                    <div className="flex items-center justify-start gap-1 group-hover:translate-y-[-5px]  transition-transform duration-150">
